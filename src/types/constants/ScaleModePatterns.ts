export const SCALE_MODE_PATTERNS = {
  ...
  LYDIAN_DOMINANT: [0, 2, 4, 6, 7, 9, 10], // 4th mode of Melodic Minor, aka the Overtone scale
  SUPER_LOCRIAN: [0, 1, 3, 4, 6, 8, 10], // Super Locrian - 7th mode of Melodic Minor, aka the Altered scale
};
