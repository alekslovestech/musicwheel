...
import { StepAnnotatedScaleFigure } from "@/components/Learn/StepAnnotatedScaleFigure";
  ...
  return (
    <>
      ...
      <p>
        ...
        from, see{" "}
        <Link href="/learn/comparisons/minor-vs-harmonic-minor" className={LEARN_STYLES.link}>
